...
/**
 * End-to-end tests exercising {@link JsonSpecToolApp} exactly as a user would invoke it, through
 * {@link CommandLine#execute(String...)} rather than calling any subcommand's logic directly.
 */
public class JsonSpecToolAppTest {
    ...
    private Captured run(String... args) throws Exception {
        ...
        CommandLine cmd = new CommandLine(new JsonSpecToolApp());
    ...
    public void noArgumentsPrintsRootUsage() throws Exception {
        ...
        assertTrue(result.out().contains("picocli-jsonspec"));
