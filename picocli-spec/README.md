...
- **JSON format reference:** [`command-spec.schema.json`](src/main/resources/picocli/spec/command-spec.schema.json)
  (also published at <https://wstein.github.io/picocli/spec/schema/command-spec.schema.json>,
  which always tracks the latest release — pin `.../spec/schema/<version>/command-spec.schema.json`,
  e.g. `.../spec/schema/4.8.0/...`, for a specific release's exact schema, kept permanently)
- **Javadoc:** <https://wstein.github.io/picocli/apidocs/picocli-spec/>
- **Full worked example:** [`flix.picocli`](src/test/resources/picocli/spec/fixtures/flix.picocli) /
  [`flix.json`](src/test/resources/picocli/spec/fixtures/flix.json), exercised end to end by
...
[`flix.json`](src/test/resources/picocli/spec/fixtures/flix.json), enforced by
`CommandSpecFixturesTest`):
...
[`picocli-spec-tool`](../picocli-spec-tool) module — a picocli command line tool built on
top of this one:
