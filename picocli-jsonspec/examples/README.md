...
`src/test/java/picocli/jsonspec/` (see `FlixExampleTest` and `Flix0762ExampleTest`).
...
A picocli-jsonspec DSL spec for the same real [flix](https://flix.dev) CLI, at a much later
